                ...
                <div class="card-body">
                    <div class="accordion accordion-flush" id="accordionFlushExample">
                        <div class="accordion-item">
                            ...
                            <button class="accordion-button btn-light collapsed" type="button" data-bs-toggle="collapse" data-bs-target={'#'+this.props.content.title.replace(/\s+/g, '')} aria-expanded="false" aria-controls="flush-collapseOne">
