const CONTENT = {
    ...
    images: {
        cat:require('./cat.png'),
        garden:require('./garden.jpeg'),
        maroonbells:require('./maroonbells.jpeg'),
        starbase:require('./starbase.jpeg'),
        mechazilla:require('./mechazilla.jpeg'),
        carmel:require('./carmel.jpeg'),
        stream:require('./stream.jpeg'),
        midland:require('./midland.jpeg'),
        brk:require('./brk.jpeg'),
        pebble:require('./pebble.jpeg'),
        saturn5:require('./saturn5.jpeg'),
        cash:require('./cash.jpeg'),
        cashmace:require('./cashmace.jpeg'),
        solar:require('./solar.png'),
        lostwhale:require('./lostwhale.png'),
        mendocino:require('./mendocino.png'),
        redwoods:require('./redwoods.png'),
        onetree:require('./onetree.png'),
        trinidad:require('./trinidad.png'),
    },
    words: {
