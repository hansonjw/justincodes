const WORDS = {
    uco: [
        ...
        "Much of my time at CU was spent in the UNIX workstation lab where I built 3D models, computed stress and strain of mechanical systems, and modeled temperature gradients and fluid flow.  To accomplished all of this I used high level, cuttent edge software such as Finite Element Analysis (FEA), Computer Aided Drafting (CAD), computational fluid dynamics (CFD), and Matlab.",        
        "One of my favorite courses at CU was a Computer Science course which taught us the fundamentals of Data Structures and Algorithms through programming in C++.",
    ...
    und: [
        "Early in my career I received my first exposure to business and quickly saw that financial acumen was crucial to good decision making and is the Achilles heel of many otherwise good engineers.  My interest in economics was piqued and I began to sense the liberating advantages in disciplined investment analysis.",
        "At this time the world began to change in a big way.  The financial industry was entering the era of ‘big data’ and was calling for those with analytical and computing skills.  Given my technical background and interest in economics, getting an MBA was a logical next step for me.",
    ...
    uca: [
        "I like to think back to the early 20th century when humanity flew for the first time, illuminated the world with electricity, developed the assembly line, made huge advances in medicine, and began to communicate across the world in real time.  These technological advancements changed to world forever and culminated in a period called “the roaring 20’s”, a period of rapid economic growth and prosperity.",
        "The parallels of “the roaring ’20’s” with today are hard to ignore.  I want to ride the wave of this new technology driven economy.  To that end and with a clear sense of my strengths and interests, I sought a formal and rigorous environment to learn code.",
        "I found a perfect fit with the full-stack web-development course at the University of California Berkeley Extension.  In this course I enhanced my skillset with fundamentals in JavaScript and web technologies."
    ],
    
    intro: [
        "I am a full stack developer with a strong curiosity in math, science, economics, and technology.  I'm facinated by how the confluence of these subjects are furthering humanity.",
