const WORDS = {
    ...
    und: [
    "As my career progressed, especially in a manufacturing environment, I received my first exposure to the business side of large scale economic human endeavors.",
    "My interest in economics as an academic subject was piqued, and I quickly saw that financial and investment acumen were crucial to good decision making and, most surprisingly to my young self, being a good engineer.",
    ...
    "At Notre Dame I found a wonderful community of disciplined, like-minded, intellectually curious thinkers and learners.  Here I was exposed to some of the largest and most successful companies in the world. I am extremely grateful for my experience at Notre Dame.",
    ],
    
    em: [
    "After earning an MBA I was fortunate to land a role at one of the worlds oldest, largest, and most successful bluechip corporations in ExxonMobil.",
    "Here I got to work on fascinating, world scale projects and infrastructures that are unparalleled in most of business.  Through this I clearly saw how big data and data science are shaping the business and technological landscape.",
    "A key passion I discovered at ExxonMobil was leveraging data science, computation, and big data to convert raw data into meaningful information. I saw the real power in understanding databases, applied computation, code, and web-development at the highest level in business.",
    ],
    ...
    intro: [
    "I am a full stack engineer and developer.  More importantly, I am a lifelong learner with a strong curiosity in technology and how it is being utilized to further humanity.",
    "My experience is well-rounded and includes analytics at ExxonMobil - one of the world's oldest and most successful bluechip companies. ",
