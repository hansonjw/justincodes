const WORDS = {
    ...
    uca: [
      ...
      "With the coding boot camp at the University of California Berkeley Extension, I found a perfect aligning thread to my experience. In this course, I learned the fundamentals of good code."
    ],
    ...
    midland: [
        `This is West Texas, the epicenter of a major oil production renaissance beginning in the mid-2000s. During this renaissance, the US began to double its oil production capacity and, by 2018, became the world's largest oil producer surpassing Russia and Saudi Arabia.`,
    ...
    acquarius: [
        `Contracts on these large drill-ships cost upwards of half a million dollars per day and more, and are often contracted for multiple years at a time. Getting the negotiations right and leveraging data for market intelligence could result in tens of millions of dollars in savings for ExxonMobil.`
    ],
}
